...
public class RankingShowCollision extends BaseCollision implements UpdateableEntityCollision {
    protected RankingShowCollider collider;

    public RankingShowCollision(RankingShowCollider c) {
        collider = c;
    }

    @Override
    public RankingShowCollider getCollider() {
        return collider;
    }
